...
public class PayPwdServiceImpl implements PayPwdService {
    ...
    private static final Logger log = LoggerFactory.getLogger(PayPwdServiceImpl.class);

    @Override
    public BaseJsonReqVo getReqJsonUpdatePayPwd(Map<String, String> params) {
        ...
        body.put("pswordCode", params.get("pswordCode"));
        ...
        log.info("修改支付密码订单号:{},请求信息:{}", merOrderNo, jsonReq);
    ...
    public BaseJsonReqVo getReqJsonResetPayPwd(Map<String, String> params) {
        ...
        String jsonReq = JSON.toJSONString(baseJsonReqVo, true);
        log.info("重置支付密码订单号:{},请求信息:{}", merOrderNo, jsonReq);
        return baseJsonReqVo;
    }
}
